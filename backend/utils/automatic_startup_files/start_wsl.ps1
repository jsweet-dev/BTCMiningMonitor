...
Start-Process -FilePath "wsl.exe" -ArgumentList "--distribution Ubuntu" -NoNewWindow -RedirectStandardOutput C:\Users\Jonathan\wsl_network\stdout.txt -RedirectStandardError C:\Users\Jonathan\wsl_network\stderr.txt
